...
assassin4 = Assassin.create(name: "Crazy Joe", image_url: "https://listverse.com/wp-content/uploads/2012/04/50336_45755462571_4089_n.jpg", description: "You can get much further with a kind word and a gun than you can with just a kind word.", price: "$10,000 (*adjusted for inflation)")
...
mark = assassin5.marks.create(name: "Frank", image_url: "https://i.pinimg.com/236x/4a/63/10/4a6310b5f4868d394aff9eb81a2a4645--frank-sinatra-mugshot-celebrity-mugshots.jpg", description: "His voice offends me.")
...
mark = assassin5.marks.create(name: "Mr.Rogers", image_url: "https://dwzwq1zlgpr34rpg91aveun6-wpengine.netdna-ssl.com/wp-content/uploads/2018/03/mister_rogers_feature_2_1050x700.jpg", description: "A neighborhood man.")
# mark.create_cat(name: "fluffy", image_url: "https://ichef.bbci.co.uk/images/ic/720x405/p0517py6.jpg", description: "very fluffy")
# mark.save

assassin7.marks.create(name: "Sue Sylvester", image_url: "https://upload.wikimedia.org/wikipedia/en/thumb/d/da/Sue_Sylvester_Glee.jpeg/220px-Sue_Sylvester_Glee.jpeg", description: "She was too mean to Rachel, the school board has had enough.")

assassin3.marks.create(name: "Joffrey", image_url: "http://24.media.tumblr.com/tumblr_n400q88Eg31qh4x1xo1_1397441798_cover.jpg", description: "Unfit to rule.")

assassin3.marks.create(name: "Nurse Rachet", image_url: "http://birthmonopoly.com/bmp/wp-content/uploads/2015/11/ratched_zps8b084dba.jpg", description: "Worst nurse I've ever had.")
